...
2. Interacting with the Chatbot:
    Change Box Contents:
        Imagine the chatbot asks you for your favorite color. Create a variable named userFavoriteColor and store your favorite color in it. Then, print a message like: "Your favorite color is red." **Make sure to use the variable's content in the message.**

        Now, imagine the chatbot asks how you feel today. Create a variable named userMood and store a mood (e.g., "happy", "sad", "excited"). Print a message like: "Today, you are feeling mad." **Make sure to use the variable's content in the message.**
"""
userFavoriteColor = "blue"
print("Your favorite color is " + userFavoriteColor)
userMood = "happy"
print("Today, you are feeling " + userMood)
"""
